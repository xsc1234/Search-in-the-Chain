...
class EvaluateRetrieval:
    ...
    def retrieve_zhongdian(self, corpus: Dict[str, Dict[str, str]], queries: Dict[str, str], **kwargs) -> Dict[str, Dict[str, float]]:
        if not self.retriever:
            raise ValueError("Model/Technique has not been provided!")
        return self.retriever.search_zhongdian(corpus, queries, self.top_k, self.score_function, **kwargs)
    ...
    def evaluate(qrels: Dict[str, Dict[str, int]], 
        ...
        return ndcg[f"NDCG@10"], _map, recall, precision
